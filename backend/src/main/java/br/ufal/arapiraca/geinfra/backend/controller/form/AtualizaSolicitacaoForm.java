...
public class AtualizaSolicitacaoForm {
    ...
    public Solicitacao atualizar(Solicitacao solicitacao, Unidade unidade, Setor setor){
        solicitacao.setNomeSolicitante(nomeSolicitante);
        solicitacao.setEmail(email);
        solicitacao.setTelefone(telefone);
        solicitacao.setSiape(siape);
        solicitacao.setLocal(local);
        solicitacao.setMidia(midia);
